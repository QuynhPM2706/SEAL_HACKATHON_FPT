...
export function AwardsResultsPage() {
  ...
  const pendingMessage = (() => {
    ...
    if (!isPublic) {
      return "Results appear after Final results are published (leaderboard becomes public automatically).";
    }
    return "Results appear after Final results are published. Assign Awards to issue prizes and certificates.";
  })();
