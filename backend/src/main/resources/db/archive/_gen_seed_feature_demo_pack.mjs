...
addEvent(uid(5, 1, 1), "Test 5 - Near Deadline Alert (Not Submitted)", "ACTIVE", -1, 3, -20, -2, "ACTIVE prelim; 10 teams; 6 submitted full; 4 not started; deadline ~9h; alert on Eta (not submitted).");
